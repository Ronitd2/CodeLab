    ...
    return(
        ...
        {/* <div className="flex-col items-center h-screen w-screen justify-center"> */}
            ...
            <div className="flex items-center justify-center h-screen w-screen ">
                ...
                <div className="flex items-center justify-center mt-7">
                <button onClick={()=>{context.loginwithgoogle()}} className="max-w-70 border-2 border-gray-950 bg-white rounded-md p-3">Sign up with google <img className="w-8 h-6  inline-block pl-2" src={googlelogo}></img></button>
                </div>
